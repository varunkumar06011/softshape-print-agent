...
export async function listTransactionsEdge(
  ...
  for (const order of settledOrders) {
    ...
    txns.push({
      ...
      cashAmount: paymentData.cashAmount != null ? Number(paymentData.cashAmount) : null,
      cardAmount: paymentData.cardAmount != null ? Number(paymentData.cardAmount) : null,
  ...
  for (const row of walkinRows) {
    try {
      ...
      txns.push({
        ...
        cashAmount: txn.cashAmount != null ? Number(txn.cashAmount) : null,
        cardAmount: txn.cardAmount != null ? Number(txn.cardAmount) : null,
